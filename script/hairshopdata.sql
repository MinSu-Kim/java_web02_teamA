...
values
(null,'guest1','1234', '골드', '김남호', '010-0000-0000', 'klr@naver.com', '1994-01-13', '2000-01-01', 0, null),
(null,'guest2','1234', '실버', '권영각', '010-0000-0000', 'klr@naver.com', '1994-01-13', '2000-01-01', 1000, null),
(null,'guest3','1234', '브론즈', '현종훈', '010-0000-0000', 'klr@naver.com', '1994-01-13', '2000-01-01', 2000, ''),
(null,'guest4','1234', '골드', '김다영', '010-0000-0000', 'klr@naver.com', '1994-01-13', '2000-01-01', 3000, '깐간합니다')
;

INSERT INTO hairshop.designer
(d_id,d_password,d_grade, d_name, d_tel, d_tel2, d_addr, d_addr2, d_addr3, d_birth, d_join, d_memo)
values
( 'user1','1234','마스터', '차홍', '010-0000-0000', '053-000-0000', '151123', '대구광역시동구', '우방맨션 103동 301','2000-01-01', '2015-01-01','깐깐합니다'),
( 'user2','1234','매니저', '김홍', '010-0000-0000', '053-000-0000', '151123', '대구광역시동구', '우방맨션 103동 302','2000-01-01', '2015-01-01','깐깐합니다'),
( 'user3','1234','직원', '권홍', '010-0000-0000', '053-000-0000', '151123', '대구광역시동구', '우방맨션 103동 303','2000-01-01', '2015-01-01','깐깐합니다'),
( 'user4','1234','직원', '현홍', '010-0000-0000', '053-000-0000', '151123', '대구광역시동구', '우방맨션 103동 304','2000-01-01', '2015-01-01','깐깐합니다')
;
