...
public class WorkDialog {
	...
	public String toString() {
		return String.format("WorkDialog [%s, %s, %s, %s, %s, %s]", w_no, w_wrokTime, w_reservTime, w_e_name, w_d_no,
				w_c_no);
	}

	public Object[] toArray() {
		return new Object[] { w_no, w_wrokTime, w_reservTime, w_e_name, w_d_no, w_c_no };
	}
