...
public class Designer {
	...
	public String toString() {
		return String.format("Designer [%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s]", d_no, d_grade, d_name, d_tel,
				d_tel2, d_addr, d_addr2, d_addr3, d_birth, d_join, d_memo);
	}

	public Object[] toArray() {
		return new Object[] { d_no, d_grade, d_name, d_tel, d_tel2, d_addr, d_addr2, d_addr3, d_birth, d_join, d_memo };
	}
}
