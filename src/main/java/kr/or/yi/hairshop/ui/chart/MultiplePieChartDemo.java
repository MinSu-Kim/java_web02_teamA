 ...
 *
 */
public class MultiplePieChartDemo extends ApplicationFrame {
     ...
     */
    public MultiplePieChartDemo(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final MultiplePieChartDemo demo = new MultiplePieChartDemo("Multiple Pie Chart Demo 1");
        demo.pack();
